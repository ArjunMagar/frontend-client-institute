                                ...
                                <div className="flex flex-col md:flex-row gap-4">
                                            ...
                                            <table className="w-full">
                                                ...
                                                <tbody >
                                                    {items.length > 0 && items.map((item) => {
                                                        return (
                                                            <tr key={item.cartId}>
                                                                <td onClick={() => router.push(`/${item.instituteId}/courses/${item.courseId}`)} className="py-4 cursor-pointer" style={{ padding: "16px 0px" }}>
                                    ...
                                    <div className="md:w-1/4">
                                        <div className="bg-white rounded-lg shadow-md p-6" style={{ padding: "24px" }}>
                                            ...
                                            <button onClick={() => router.push("/order/checkoutbycart")} className="bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full btn" style={{ padding: "8px 16px", marginTop: "16px" }}>Checkout</button>
                                        </div>
                                    </div>
                                </div>) ||
