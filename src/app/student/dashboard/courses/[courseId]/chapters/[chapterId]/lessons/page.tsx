...
function StudentChapterLessons() {
        ...
        <>
            <div>
                ...
                <div className="container mx-auto px-4 py-8">
                    <h1 className="text-3xl font-bold text-center mb-8">Lessons</h1>
                        ...
                        <table className="w-full table-auto">
                            <thead>
                                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th className="py-3 px-6 text-left">LessonVideo</th>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-6 text-center">
                                                    <button
                                                        onClick={() => router.push(`/student/dashboard/courses/${courseId}/chapters/${chapterId}/lessons/${lesson.id}?instituteId=${instituteId}`)}
                                                ...
                                                <td className="py-3 px-6 text-center">
                                                    <div className="flex item-center justify-center">
                                                        ...
                                                        <button
                                                            //   onClick={() => openModal1(chapter.courseId)}
                                                            className="w-4 mr-2 transform hover:text-blue-500 hover:scale-110"
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
...
export default StudentChapterLessons;
